...
namespace HEngine
{
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, float tilingFactor = 1.0f, const glm::vec4& tinColor = glm::vec4(1.0f), int entityID = -1);
